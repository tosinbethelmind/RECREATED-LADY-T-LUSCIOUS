    ...
    <div className="bg-background min-h-screen">
      <div className="relative h-[400px] flex items-center justify-center text-center text-white">
        ...
        <div className="container relative z-20">
          <h1 className="text-4xl md:text-5xl font-bold font-serif">Our Heritage</h1>
        </div>
      </div>
      ...
      <div className="container py-16 md:py-24">
        <div className="max-w-3xl mx-auto space-y-8 text-lg text-stone-600">
          <p>
            ...
            We are London's premier destination for authentic African cuisine and exquisite handcrafted pastries.
          </p>
          
          <p>
            Our journey began with a passion for the bold, vibrant flavors of West Africa. What started as a small family kitchen preparing traditional Jollof Rice and Egusi soup for friends has grown into a beloved culinary establishment. We blend the rich, spicy heritage of African cooking with modern techniques to bring you a taste of home, right here in the UK.
          </p>
          
          <p>
            But we are more than just savory dishes. Our "Creamy Cake & Pastries" line offers a sweet finish to every meal, featuring wedding cakes, birthday treats, and our famous soft, pillowy Puff Puff.
          </p>
          ...
          <div className="my-12 p-8 bg-beige rounded-xl border-l-4 border-primary">
            ...
            <p className="italic text-stone-700">
              "Food is a language of love. Whether it's the heat of the scotch bonnet or the sweetness of buttercream, every ingredient tells a story."
            </p>
          </div>
